...
class ComplainantModel extends CI_Model
{
    ...
    public function complainant_edit($data_arr)
    {
        ...
        $optional_update_cols = array('complainant_district_id_fk','complainant_council','complainant_name','complainant_guardian_name','complainant_contact','complainant_cnic','complainant_gender','complainant_email','complainant_address','complainant_image');
